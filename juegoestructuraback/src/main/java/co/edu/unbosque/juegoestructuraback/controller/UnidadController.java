...
public class UnidadController {
	...
	@PostMapping("/generar")
	public ResponseEntity<UnidadDTO[]> generar(@RequestParam int n, @RequestParam String tipo,
	...
	@GetMapping("/mover")
	public ResponseEntity<List<Point>> mover(@RequestParam Long id, @RequestParam int x, @RequestParam int y) {
	...
	/**
	 * GET /unidad/rango?id=<id> Devuelve el listado de puntos accesibles según el
	 * atributo movimiento de la unidad.
	 */
	@GetMapping("/rango")
	public ResponseEntity<List<Point>> rango(@RequestParam Long id) {
